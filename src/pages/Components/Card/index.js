...
export default function Card({ id, data }) {
    ...
    return (
        <Pressable style={styles.container} onPress={() => navigation.navigate('Scheduling', { id: id, name: data.commitment, day: data.day, month: month[data.month - 1], details: data.details})}>
